...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    ...
    if (!window.google || !clientId || clientId.includes('mockclientid')) {
      console.warn('Real Google SDK not loaded or Client ID unconfigured. Launching Google Account Simulator.');
      ...
      if (!popup) {
        return setError('Pop-up blocked. Please allow popups for this site to sign in with Google.');
      }
