...
app.use(cors({
    origin: true,
    credentials: true,
    allowedHeaders: ['Content-Type', 'Authorization', 'x-tenant-subdomain', 'x-user-id', 'x-user-role', 'x-requested-with']
}));

// Security & COOP Headers for Google OAuth / Google Identity Compatibility on Render
